...
public:
                         ...
                         const chip::app::StatusIB & status) override
    {
      ...
      MatterTaskHandler::OnRetrieveCommandComplete(path, data, status);
#endif
    ...
    void OnError(CHIP_ERROR error) override
    {
        ...
        g_DestinationNodeId = GetDestinationNodeId();
        MatterTaskHandler::OnRetrieveCommandCompleteError(error);
#endif
...
protected:
    ...
    void OnDone(chip::app::ReadClient * aReadClient) override
    {
        ...
        g_DestinationNodeId = GetDestinationNodeId();
//        MatterTaskHandler::OnInvokeCommandComplete(error);
#endif
