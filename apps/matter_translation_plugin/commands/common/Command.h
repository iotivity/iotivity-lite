...
public:
...
#if OC_BRG
    /*
     * <2023/11/13> enclosing_method() : added
     */
    typedef enum {
      COMMAND_INTERACTIVE_NORMAL,
      COMMAND_INTERACTIVE_INIT,
      COMMAND_INTERACTIVE_SHUTDOWN
    } ClientInitState;

    ClientInitState GetInitState() { return mInitState; }
#endif
     ...
     * <2023/11/13> enclosing_method() : added
     */
    CHIP_ERROR RunAsInitiate(ClientInitState state)
    {
        mInitState = state;
        return Run();
    }
...
private:
     ...
     * <2023/11/13> enclosing_method() : added
     */
    ClientInitState mInitState = COMMAND_INTERACTIVE_NORMAL;
#endif
