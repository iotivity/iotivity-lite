...
#if OC_BRG
/*
 * <2023/11/15> InteractiveStopCommand() : new class
 */
class InteractiveStopCommand : public InteractiveCommand
{
public:
    InteractiveStopCommand(Commands * commandsHandler, CredentialIssuerCommands * credsIssuerConfig) :
        InteractiveCommand("stop", commandsHandler, credsIssuerConfig)
    {}
