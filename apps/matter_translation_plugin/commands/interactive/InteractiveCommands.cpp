...
#else
    /*
     * <2023/11/13> InteractiveStartCommand::RunCommand() : modified to be run just once..
     */
    OC_BRG_LOG("running Interactive Start command...");
#endif
...
#if OC_BRG
/*
 * <2023/11/15> InteractiveStopCommand::RunCommand() : new method
 */
CHIP_ERROR InteractiveStopCommand::RunCommand()
{
    OC_BRG_LOG("running Interactive Stop command...");
    SetCommandExitStatus(CHIP_NO_ERROR);
    return CHIP_NO_ERROR;
}
#endif
