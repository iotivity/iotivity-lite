...
char g_3DPrinter_RESOURCE_ENDPOINT[] = "/3D Printer";  // used path for this resource
...
char g_AudioControls_RESOURCE_ENDPOINT[] = "/Audio Controls";  // used path for this resource
