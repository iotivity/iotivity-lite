...
static void cb_retrieve_light1(oc_request_t *request, oc_interface_mask_t iface_mask,
		void *user_data)
{
	(void) user_data;
...
static void cb_retrieve_light2(oc_request_t *request, oc_interface_mask_t iface_mask,
		void *user_data)
{
	(void) user_data;
...
int main(void)
{
	...
	{ .init = app_init, .signal_event_loop = signal_event_loop,
