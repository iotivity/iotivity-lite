...
void st_data_mgr_info_remove_all(void);

void st_data_mgr_info_print_all(void);

st_specification_t *st_data_mgr_get_spec_info(void);
st_resource_t *st_data_mgr_get_resource_info(void);
st_resource_type_t *st_data_mgr_get_rsc_type_info(void);
