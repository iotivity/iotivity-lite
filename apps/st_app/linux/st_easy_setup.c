...
interface_event_handler(oc_interface_event_t event)
{
  if (event == NETWORK_INTERFACE_UP) {
    printf("==========================================interface_event_handler "
           "UPUPUPUPUPUPUPUPUPUPUPUPUPUPPUPUPUPUPUPUUPUPPUPUPUPUPUPUUP\n");
    // oc_remove_network_interface_event_callback(interface_event_handler);
  } else {
    printf("==========================================interface_event_handler "
           "DOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOWNDOW"
           "N\n");
  }
}
