...
void createResourceWithUrl()
{
    printf("I am in the createResourceWithUrl\n");
}
/*
...
int main(int argc,char* argv[])
{
    ...
    //while(1);
    int stack_init = MainPollIntialisation();
    if(stack_init < 0)
    {
        printf("Stack Intialisation is not happened");
    }
    else 
    {
