...
char discoverUriPost[MAX_URI_LENGTH];
...
static bool s_isRequestSucessfull = false;
...
char observeUri[MAX_URI_LENGTH];
oc_endpoint_t *observeEndpoint = NULL;
...
void selectMenu(int choice)
{
    ...
    switch(choice) {
        ...
        case 31:
            ...
            /* 'count_switchCase31' specifies the number of bytes allocated to 'char* collection_uri_input'
            using malloc */
            unsigned int count_switchCase31 = 25;
            char* collection_uri_input = malloc((size_t)count_switchCase31);
        ...
        case 33:
            ...
            /* 'count_switchCase33' specifies the number of bytes allocated to 'char* collection_uri_input2'
            using malloc */
            unsigned int count_switchCase33 = 25;
            char* collection_uri_input2 = malloc((size_t)count_switchCase33);
        ...
        case 34:
            ...
            unsigned int count_switchCase34 = 25;
            char* resource_uri_input = malloc((size_t)count_switchCase34);
...
int main( int argc, char* argv[])
{
  ...
  if (pthread_mutex_init(&app_mutex, NULL) < 0) {
    ...
    exit:
    free_all_buffer();
	oc_free_server_endpoints(observeEndpoint);
	oc_free_server_endpoints(light_server);
	oc_free_server_endpoints(resource_server);
    oc_main_shutdown();
    pthread_mutex_destroy(&mutex);
