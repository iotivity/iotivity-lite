...
char g_euicc_info[256];
char g_device_info[256];
...
register_resources(void)
{
  ...
  for(int dev_index = 0; dev_index < g_device_count; ++dev_index) {
    ...
    lpa_get_euicc_info(g_euicc_info);
    lpa_get_device_info(g_device_info);

     if (oc_ees_set_device_info(dev_index, g_euicc_info, g_device_info) == OC_ES_ERROR)
