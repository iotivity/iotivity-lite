...
static const unsigned char g_client_certificate[CLIENT_CRT_LEN] = {
  
};
// default client's key pair
static const unsigned char x509_priv_key[] = {
  0xf9, 0x42, 0xb4, 0x16, 0x89, 0x10, 0xf4, 0x07, 0x99, 0xb2, 0xe2,
  0x9a, 0xed, 0xd4, 0x39, 0xb8, 0xca, 0xd4, 0x9d, 0x76, 0x11, 0x43,
  0x3a, 0xac, 0x14, 0xba, 0x17, 0x9d, 0x3e, 0xbb, 0xbf, 0xbc
};

static const unsigned char x509_pub_key_x[] = {
  0xe3, 0xd1, 0x67, 0x1e, 0xdc, 0x46, 0xf4, 0x19, 0x50, 0x15, 0x2e,
  0x3a, 0x2f, 0xd8, 0x68, 0x6b, 0x37, 0x32, 0x84, 0x9e, 0x83, 0x81,
  0xbf, 0x25, 0x5d, 0xbb, 0x18, 0x07, 0x3c, 0xbd, 0xf3, 0xab
};

static const unsigned char x509_pub_key_y[] = {
  0xd3, 0xbf, 0x53, 0x59, 0xc9, 0x1e, 0xce, 0x5b, 0x39, 0x6a, 0xe5,
  0x60, 0xf3, 0x70, 0xdb, 0x66, 0xb6, 0x80, 0xcb, 0x65, 0x0b, 0x35,
  0x2a, 0x62, 0x44, 0x89, 0x63, 0x64, 0x6f, 0x6f, 0xbd, 0xf0
};

// default CA pub key
static const unsigned char x509_ca_pub_x[] = {
  0x57, 0x94, 0x7f, 0x98, 0x7a, 0x02, 0x67, 0x09, 0x25, 0xc1, 0xcb,
  0x5a, 0xf5, 0x46, 0xfb, 0xad, 0xf7, 0x68, 0x94, 0x8c, 0xa7, 0xe3,
  0xf0, 0x5b, 0xc3, 0x6b, 0x5c, 0x9b, 0xd3, 0x7d, 0x74, 0x12
};

static const unsigned char x509_ca_pub_y[] = {
  0xce, 0x68, 0xbc, 0x55, 0xf5, 0xf8, 0x1b, 0x3d, 0xef, 0xed, 0x1f,
  0x2b, 0xd2, 0x69, 0x5d, 0xcf, 0x79, 0x16, 0xa6, 0xbd, 0x97, 0x96,
  0x27, 0x60, 0x5d, 0xd1, 0xb7, 0x93, 0xa2, 0x4a, 0x62, 0x4d
};

// default server's key pair
static const unsigned char serv_pub_key_x[] = {
  0x07, 0x88, 0x10, 0xdc, 0x62, 0xd7, 0xe6, 0x9b, 0x7c, 0xad, 0x6e,
  0x78, 0xb0, 0x5f, 0x9a, 0x00, 0x11, 0x74, 0x2c, 0x8b, 0xaf, 0x09,
  0x65, 0x7c, 0x86, 0x8e, 0x55, 0xcb, 0x39, 0x55, 0x72, 0xc6
};

static const unsigned char serv_pub_key_y[] = {
  0x65, 0x71, 0xcd, 0x03, 0xdc, 0x2a, 0x4f, 0x46, 0x5b, 0x14, 0xc8,
  0x27, 0x74, 0xab, 0xf4, 0x1f, 0xc1, 0x35, 0x0d, 0x42, 0xbc, 0xc2,
  0x9f, 0xb5, 0xc1, 0x79, 0xb6, 0x8b, 0xca, 0xdb, 0xff, 0x82
};
             ...
             size_t id_len, unsigned char *result, size_t result_length)
{
  ...
  case DTLS_PSK_KEY:
    if (id_len != psk_server_id_length ||
        memcmp(psk_server_id, id, id_len) != 0) {
              ...
              const dtls_ecc_key_t **result)
{
  (void)ctx;
  (void)session;
  static const dtls_ecc_key_t ecdsa_key = {.curve = DTLS_ECDH_CURVE_SECP256R1,
...
#ifdef DTLS_X509
static int
get_x509_key(struct dtls_context_t *ctx, const session_t *session,
             const dtls_ecc_key_t **result)
{
  (void)ctx;
  (void)session;
  static dtls_ecc_key_t ecdsa_key = {.curve = DTLS_ECDH_CURVE_SECP256R1,
...
static int
get_x509_cert(struct dtls_context_t *ctx, const session_t *session,
...
int
check_certificate(byte_array cert_der_code, byte_array ca_public_key)
{
  (void)cert_der_code;
  (void)ca_public_key;
  return 0;
...
static int
verify_x509_cert(struct dtls_context_t *ctx, const session_t *session,
                 const unsigned char *cert, size_t cert_size, unsigned char *x,
                 size_t x_size, unsigned char *y, size_t y_size)
{
  int ret;
  ...
  memcpy(ca_public_key.data + DTLS_PUBLIC_KEY_SIZE / 2, ca_pub_y,
         DTLS_PUBLIC_KEY_SIZE / 2);
...
static int
is_x509_active(struct dtls_context_t *ctx)
{
  (void)ctx;
  return 0;
}
...
usage(const char *program, const char *version)
{
  ...
  fprintf(
    stderr,
    "%s v%s -- DTLS client implementation\n"
...
main(int argc, char **argv)
{
  ...
  while ((opt = getopt(argc, argv, "p:o:v:c:" PSK_OPTIONS X509_OPTIONS)) !=
         -1) {
    switch (opt) {
#ifdef DTLS_PSK
    case 'i': {
    ...
    case 'x': {
      ssize_t result =
        read_from_file(optarg, x509_client_cert, DTLS_MAX_CERT_SIZE);
      if (result < 0) {
    ...
    case 'r': {
      ssize_t result =
        read_from_file(optarg, x509_client_priv, DTLS_PRIVATE_KEY_SIZE + 1);
      if (result < 0) {
    ...
    case 'u': {
      ssize_t result =
        read_from_file(optarg, x509_ca_pub, DTLS_PUBLIC_KEY_SIZE + 1);
      if (result < 0) {
  ...
  } else if (!(x509_client_cert_len || x509_client_priv_is_set ||
               x509_ca_pub_is_set)) {
    ...
    if (len) {
      if (len >= strlen(DTLS_CLIENT_CMD_CLOSE) &&
        ...
        if (orig_dtls_context == NULL) {
          /* Cache the current context. We cannot free the current context as it
           * will notify
