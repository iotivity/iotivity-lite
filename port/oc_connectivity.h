...
*/
int oc_connectivity_add_network_interface_event_callback(
...
/**
  ...
  @return 0 if success. -1 return if error occur.
*/
int oc_connectivity_remove_network_interface_event_callback(
  interface_event_handler_t cb);
...
/**
  ...
  @return 0 if success. -1 return if error occur.
*/
int oc_connectivity_add_session_event_callback(session_event_handler_t cb);
...
/**
  ...
  @return 0 if success. -1 return if error occur.
*/
int oc_connectivity_remove_session_event_callback(session_event_handler_t cb);
