 ...
 * @return -1 on failure
 */
int hawkbit_validate_purl(const char *purl);
 ...
 * @return -1 on failure
 */
int hawkbit_check_new_version(size_t device, const char *url,
                              const char *version);
 ...
 * @return -1 on failure
 */
int hawkbit_download_update(size_t device, const char *url);
 ...
 * @return -1 on failure
 */
int hawkbit_perform_upgrade(size_t device, const char *url);
