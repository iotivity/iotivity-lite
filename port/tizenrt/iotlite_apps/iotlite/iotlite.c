...
#ifndef CONFIG_IOTIVITY_CONSTRAINED_CREADS_STORE
#define IOCON_CREADS_STORE "/mnt/smart_home_server_linux_creds"
#else
#define IOCON_CREADS_STORE CONFIG_IOTIVITY_CONSTRAINED_CREADS_STORE
#endif
...
#ifdef OC_SECURITY
  oc_storage_config(IOCON_CREADS_STORE);
#endif /* OC_SECURITY */
