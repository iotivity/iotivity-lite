...
If you wish to use a different version of OpenJDK you can use the following command so see which versions are avalible
...
if behind a proxy use the proxy connection options
    ...
    ./sdkmanager --proxy=<http|socks> --proxy_host=<host address> --proxy_port=<number> "platform-tools" "platforms;android-24"

</** TODO Add instructions for Android Studio **/>
