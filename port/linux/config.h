...
/* Maximum number of callbacks for IP adapter status monitoring */
#define OC_MAX_IP_ADAPTER_CBS (2)

/* Maximum number of callbacks for TCP connection monitoring */
#define OC_MAX_TCP_CONNECTION_CBS (2)
