...
struct timespec EasySetupHelper::s_ts;
...
bool EasySetupHelper::easySetupCallbackforUserData(bool isCallbackNull) {
	...
	} else if (es_set_callback_for_userdata(&readUserDataCb, &writeUserDataCb, NULL)
			!= ES_OK)
		return false;
...
bool EasySetupHelper::setDeviceInfo(bool isDevicePropertyNull) {
	...
	es_device_property device_property = { { { WIFI_11G, WIFI_11N, WIFI_11AC,
			WiFi_EOF }, WIFI_5G }, { { 0 } } };
