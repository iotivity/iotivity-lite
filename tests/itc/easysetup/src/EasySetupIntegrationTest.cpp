...
TEST(EasySetupIntegrationTest, easysetup_init_enrollee_return_check_P)
{
	...
	EasySetupHelper *m_pCloudHelper;
	m_pCloudHelper = EasySetupHelper::getInstance();
	m_pCloudHelper->createResource();

	EXPECT_TRUE(m_pCloudHelper->easySetupInitEnrollee(false,false,false));
...
TEST(EasySetupIntegrationTest, easysetup_init_enrollee_resource_mark_null_check_N)
{
	...
	EXPECT_TRUE(m_pCloudHelper->easySetupInitEnrollee(false,true,false));
...
TEST(EasySetupIntegrationTest, easysetup_init_enrollee_handler_null_check_N)
{
	...
	EXPECT_TRUE(m_pCloudHelper->easySetupInitEnrollee(false,false,true));
...
TEST(EasySetupIntegrationTest, easysetup_set_callback_return_check_P)
{
	...
	m_pCloudHelper->easySetupInitEnrollee(false,false,false);
	EXPECT_TRUE(m_pCloudHelper->easySetupCallbackforUserData(false));
...
TEST(EasySetupIntegrationTest, easysetup_set_callback_null_check_N)
{
	...
	m_pCloudHelper->easySetupInitEnrollee(false,false,false);
	EXPECT_TRUE(m_pCloudHelper->easySetupCallbackforUserData(true));
...
TEST(EasySetupIntegrationTest, easysetup_set_device_info_return_check_P)
{
	...
	m_pCloudHelper->easySetupInitEnrollee(false,false,false);
	m_pCloudHelper->easySetupCallbackforUserData(false);
	EXPECT_TRUE(m_pCloudHelper->setDeviceInfo(false));
...
TEST(EasySetupIntegrationTest, easysetup_set_device_info_null_check_N)
{
	...
	m_pCloudHelper->easySetupInitEnrollee(false,false,false);
	m_pCloudHelper->easySetupCallbackforUserData(false);
	EXPECT_TRUE(m_pCloudHelper->setDeviceInfo(true));
...
TEST(EasySetupIntegrationTest, easysetup_stop_return_check_P)
{
	...
	m_pCloudHelper->easySetupInitEnrollee(false,false,false);
	m_pCloudHelper->easySetupCallbackforUserData(false);
	m_pCloudHelper->setDeviceInfo(false);
	EXPECT_TRUE(m_pCloudHelper->stopEasySetup());
