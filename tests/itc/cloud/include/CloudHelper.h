...
public:
	...
	//cloud
	bool ocSignUpWithAuth(const char *provier, const char *address,const char *auth_code);
	bool ocSignInWithAuth();
	bool ocSignUp();
	bool ocSignUp(bool endpoint,const char *lauthprovider, const char *luid, const char *laccess_token, bool cb);

	bool ocSignInWithAuth(bool endpoint, const char *luid, const char *laccess_token, bool cb);
