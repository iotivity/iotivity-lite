...
lcov -c -d ../../ -o ${iotivity}/coverage_report/new_coverage.info && lcov --remove ${iotivity}/coverage_report/new_coverage.info 'port/unittest/*' 'deps/*' '/usr/include/*' 'api/unittest/*' 'messaging/coap/unittest/*' 'security/unittest/*' 'service/easy-setup/unittest/' 'service/fota/unittest/*'  'service/cloud-access/unittest/*'  'service/resource-directory/unittest/*' 'service/st-app-fw/unittest/*' -o ${iotivity}/coverage_report/main_coverage.info
