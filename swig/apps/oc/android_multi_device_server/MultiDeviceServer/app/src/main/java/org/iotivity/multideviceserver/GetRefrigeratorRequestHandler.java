...
public class GetRefrigeratorRequestHandler implements OCRequestHandler {
    ...
    public void handler(OCRequest request, int interfaces) {
        ...
        refrigerator.setFilter(refrigerator.getFilter() + 1); // auto increment
        refrigerator.setRapidFreeze(!refrigerator.isRapidFreeze()); // auto toggle
        refrigerator.setRapidCool(!refrigerator.isRapidCool()); // auto toggle
        refrigerator.setDefrost(!refrigerator.isDefrost()); // auto toggle

        activity.msg("\t" + refrigerator.getName() + ", " + refrigerator.getFilter() + ", " + refrigerator.isRapidFreeze() + ", " + refrigerator.isRapidCool() + ", " + refrigerator.isDefrost());
        activity.printLine();
