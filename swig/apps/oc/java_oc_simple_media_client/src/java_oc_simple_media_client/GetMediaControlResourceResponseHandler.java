    ...
    public void handler(OCClientResponse response) {
        ...
        while (rep != null) {
            ...
            case OC_REP_STRING_ARRAY:
                ...
                break;
            case OC_REP_DOUBLE:
                if ("mediaspeed".equalsIgnoreCase(rep.getName())) {
                    mediaControlResource.setSpeed(rep.getValue().getDouble());
                }
                if ("medialocation".equalsIgnoreCase(rep.getName())) {
                    mediaControlResource.setLocation(rep.getValue().getDouble());
                }
                break;
            default:
                break;
