...
public class Client {
    ...
    static private void setUriExpression() {
        ...
        userInput = scanner.nextInt();
        if (userInput == 1) {
            System.out.print("Enter media speed (eg 1.0): ");
        ...
        userInput = scanner.nextInt();
        if (userInput == 1) {
            System.out.print("Enter media location (eg 500.0): ");
    ...
    static private void sendUriExpression(String uriExp) {
        ...
        if (OcUtils.initPost(currentMediaControlResource.getServerUri(),
            ...
            root.setTextString("uriexp", "MediaControlResURI?" + uriExp);
            root.done();
