    ...
    public OCDiscoveryFlags handler(String anchor, String uri, String[] types, int interfaceMask, OCEndpoint endpoint,
        ...
        for (String type : types) {
            if (type.equals("core.light")) {
                ...
                light.setServerEndpoint(endpoint);
                light.setServerUri(uri);
                System.out.println("\tResource " + light.getServerUri() + " hosted at endpoint(s):");
                ...
                GetLightResponseHandler responseHandler = new GetLightResponseHandler(light);
                OCMain.doGet(light.getServerUri(), light.getServerEndpoint(), null, responseHandler, OCQos.LOW_QOS);
