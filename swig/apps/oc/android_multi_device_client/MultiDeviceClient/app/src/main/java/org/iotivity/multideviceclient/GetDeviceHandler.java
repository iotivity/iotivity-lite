...
public class GetDeviceHandler implements OCResponseHandler {
    ...
    public void handler(OCClientResponse response) {
        ...
        if ((di != null) && (n != null)) {
            ...
            if (!OcUtils.doIPDiscoveryAtEndpoint(null, new ResourceDiscoveryHandler(deviceInfo), response.getEndpoint())) {
                final String msg = "Error issuing resource discovery request for uuid " + di;
                Log.d(TAG, msg);
