...
import java_onboarding_tool.MyObtDiscoveryHandler;
...
public class ObtMain {
    ...
    private static MyObtDiscoveryHandler obtDiscoveryHandler = new MyObtDiscoveryHandler();
    ...
    public static void discoverUnownedDevices()
    {
        ...
        appSyncLock.lock();
        if ( 0 > OCObt.discoverUnownedDevices(obtDiscoveryHandler)) {
