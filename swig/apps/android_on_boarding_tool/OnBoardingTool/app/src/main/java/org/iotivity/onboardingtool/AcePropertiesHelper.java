                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    OCObt.aceResourceSetWc(aceResource, OCAceWildcard.OC_ACE_WC_ALL_DISCOVERABLE);
                                    break;
                                case 3:
                                    OCObt.aceResourceSetWc(aceResource, OCAceWildcard.OC_ACE_WC_ALL_NON_DISCOVERABLE);
                                    break;
                                default:
                                    break;
                            }
        ...
        resourceTypesAlertDialogBuilder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!resourceTypes.isEmpty()) {
                    ...
                    OCObt.aceResoruceSetNumRt(aceResource, types.length);
                    for (String resType : types) {
                        ...
                        if (!resType.isEmpty()) {
                            ...
                            OCObt.aceResoruceBindRt(aceResource, resType);
                        }
                    }
                }
