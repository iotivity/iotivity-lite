...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    private OCObtStatusHandler provisionCredentialsHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        provisionCredentialsHandler = new ProvisionCredentialsHandler(this);
        provisionAce2Handler = new ProvisionAce2Handler(this);
                                    ...
                                    selectDialogBuilder.setItems(secondDeviceList, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            new Thread(new Runnable() {
                                                public void run() {
                                                    if (OCObt.provisionPairwiseCredentials(OCUuidUtil.stringToUuid(uuid), OCUuidUtil.stringToUuid(uuidPair), provisionCredentialsHandler) < 0) {
                                ...
                                case 1: // Provision ACE2
                                    ...
                                    aceDialogBuilder.setItems(aceSubjectList, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (ace != null) {
                                                AcePropertiesHelper acePropertiesHelper = new AcePropertiesHelper(OnBoardingActivity.this);
                                                acePropertiesHelper.getProperties(ace);
                                                new Thread(new Runnable() {
                                                    public void run() {
