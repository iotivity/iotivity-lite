...
public class OCEndpointTest {
    ...
    public void testStringToEndpoint() {
        ...
        } catch (OCEndpointParceException e) {
            e.printStackTrace();
            fail("stringToEndpoint threw exception when it was not expected. For " + e.getParsedData());
        }
        assertNotNull(ep);
    ...
    public void test_throw_parse_exception_stringToEndpoint() {
        ...
        try {
            ...
            assertEquals("String cannot be parced.", e.getMessage());
            assertEquals("coaps+tcp", e.getParsedData());
        }
        ...
        try {
            ...
            assertEquals("String cannot be parced.", e.getMessage());
            assertEquals("foobar", e.getParsedData());
        }
    }
}
