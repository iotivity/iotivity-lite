...
javac -source 1.7 -target 1.7 -sourcepath ../iotivity-lite-java/src  -d ../iotivity-lite-java/bin  ../iotivity-lite-java/src/org/iotivity/*.java

# create jar file
jar -cfv iotivity-lite.jar -C ../iotivity-lite-java/bin  .
