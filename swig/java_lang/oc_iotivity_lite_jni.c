                                      ...
                                      void *user_data)
{
  ...
  //                               cls_OCEndpoint, mid_OCEndpoint_init,
  //                               (jlong)ep, true);
  //    JCALL3(SetObjectArrayElement, (data->jenv), jendpoints, (jsize)ep_size,
  //    jendpoint);
  //}
  ...
  const jmethodID mid_handler =
    JCALL3(GetMethodID, (data->jenv), cls_OCDiscoveryAllHandler, "handler",
           ...
           "[Ljava/lang/String;I[Lorg/iotivity/OCEndpoint;IZ)"
           "Lorg/iotivity/OCDiscoveryFlags;");
  assert(mid_handler);
  jobject jDiscoveryFlag =
    JCALL9(CallObjectMethod, (data->jenv), data->jcb_obj, mid_handler, janchor,
