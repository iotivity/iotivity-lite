...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
  ...
  const jmethodID getFileDirsMethod = JCALL3(GetMethodID, jenv, activityClass,
...
oc_discovery_flags_t jni_oc_discovery_all_handler_callback(
  ...
  jobject jDiscoveryFlag =
      JCALL9(CallObjectMethod, (data->jenv), data->jcb_obj, mid_handler,
             janchor, juri, jtypes, jinterfaceMask, jendpoint,
             jresourcePropertiesMask, (jboolean)more);
