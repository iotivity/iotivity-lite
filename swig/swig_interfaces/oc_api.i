...
%rename (repSetLong) jni_rep_set_long;
%inline %{
...
%rename(repSetLongArray) jni_rep_set_long_array;
%inline %{
...
%rename(repGetLong) jni_rep_get_long;
%inline %{
...
%rename(repGetLongArray) jni_rep_get_long_array;
%inline %{
