...
int jin_oc_init_platform1(const char *mfg_name, oc_init_platform_cb_t init_platform_cb, jni_callback_data *jcb, void *user_data) {
 OC_DBG("JNI: %s\n", __FUNCTION__);
  jcb->juser_data = *(jobject*)user_data;
...
int jni_oc_init_platform0(const char *mfg_name);
%rename(initPlatform) jin_oc_init_platform1;
int jin_oc_init_platform1(const char *mfg_name, oc_init_platform_cb_t init_platform_cb, jni_callback_data *jcb, void *user_data);
