...
bool jni_delete_resource(oc_resource_t *resource) {
  if(resource) {
    if(resource->get_handler.user_data) {
      jni_list_remove(resource->get_handler.user_data);
    }
    if(resource->put_handler.user_data) {
      jni_list_remove(resource->put_handler.user_data);
    }
    if(resource->post_handler.user_data) {
      jni_list_remove(resource->post_handler.user_data);
    }
    if(resource->delete_handler.user_data) {
      jni_list_remove(resource->delete_handler.user_data);
    }
  }
