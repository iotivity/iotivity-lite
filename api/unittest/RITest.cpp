...
static bool d_isCallbackReceived;
...
static void onGet(oc_request_t *request, oc_interface_mask_t interface, void *user_data)
{
        ...
        (void)interface;
        (void)user_data;
        d_isCallbackReceived = true;
}

TEST_F(TestRetroIntrospection, GetAppResourceByUriTest_P)
{
    oc_resource_t *res;
    oc_resource_t *res1;
...
TEST_F(TestRetroIntrospection, GetAppResourceByUriTest_N)
{
    oc_resource_t *res1;
...
TEST_F(TestRetroIntrospection, RiGetAppResourceTest_P)
{
    oc_resource_t *res;
    oc_resource_t *res1;
...
TEST_F(TestRetroIntrospection, RiGetAppResourceTest_N)
{
    oc_resource_t *res;
...
TEST_F(TestRetroIntrospection, RiAllocResourceTest_P)
{
    oc_resource_t *res;
...
TEST_F(TestRetroIntrospection, RiDeleteResourceTest_P)
{
    oc_resource_t *res;
    bool del_check;
...
TEST_F(TestRetroIntrospection, RiFreeResourcePropertiesTest_P)
{
    oc_resource_t *res;
...
TEST_F(TestRetroIntrospection, RiAddResourceTest_P)
{
    oc_resource_t *res;
    bool res_check;
