...
TEST(B64Test, RFC4648_EncodeTestVectors) {
  char buf[128];
  int outputLength = 0;
  const char *input[] = { "", "f", "fo", "foo", "foob", "fooba", "foobar" };

  const char *output[] = { "",         "Zg==",     "Zm8=",    "Zm9v",
                           "Zm9vYg==", "Zm9vYmE=", "Zm9vYmFy" };

  const size_t expectedOutputLenth[] = { 0, 4, 4, 4, 8, 8, 8 };
...
TEST(B64Test, RFC4648_DecodeTestVectors) {
  ...
  const char *input[] = { "",         "Zg==",     "Zm8=",    "Zm9v",
                          "Zm9vYg==", "Zm9vYmE=", "Zm9vYmFy" };

  const char *output[] = { "", "f", "fo", "foo", "foob", "fooba", "foobar" };

  const size_t expectedOutputLenth[] = { 0, 1, 2, 3, 4, 5, 6 };
...
TEST(B64Test, encoder_does_not_null_terminate) {
  char buf[128] = { 0 };
  int outputLength = 0;
  const char *input[] = { "foobar", "foo" };

  const char *output[] = { "Zm9vYmFy", "Zm9v" };

  const size_t expectedOutputLenth[] = { 8, 4 };
