...
TEST_F(TestCoreResource, InitPlatformTest_P)
{
...
TEST_F(TestCoreResource, CoreInitPlatformTest_P)
{
...
TEST_F(TestCoreResource, CoreDeviceTest_P)
{
    int numcoredevice;
