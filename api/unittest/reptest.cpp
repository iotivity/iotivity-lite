...
TEST(TestRep, OCRepSetGetByteString)
{
  ...
  // if we have dynamic allocation we can encode the byte string and fill the
  // remaining space. Without dynamic allocation we can not encode the bytes.
#ifdef OC_DYNAMIC_ALLOCATION
  const char too_small_json[] = "{\"test_byte_string\":\"AQIDBA";
#else
