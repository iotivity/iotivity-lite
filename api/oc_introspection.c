...
//#define OC_IDD_FILE 1

#define MAX_FILENAME_LENGTH 128
#define INVALID_FILENAME ""

#if !defined OC_IDD_API && !defined OC_IDD_FILE
#include "server_introspection.dat.h"
#else /* OC_IDD_API or OC_IDD_FILE */
...
#ifdef OC_IDD_FILE
  gen_idd_tag("IDD_FILENAME", device, idd_tag);
  oc_storage_write(idd_tag, (uint8_t *)INVALID_FILENAME,
                   sizeof(INVALID_FILENAME));
#endif
#endif /* OC_SECURITY */
}
#endif /* IC_IDD_API */
...
{
  char idd_tag[MAX_TAG_LENGTH];
  gen_idd_tag("IDD_FILENAME", device_index, idd_tag);
...
#endif /* !OC_IDD_API and !OC_IDD_FILE */
                                   ...
                                   oc_interface_mask_t iface_mask, void *data)
{
  ...
  int fn_ret = get_IDD_filename(index, filename);
  ...
  if (fn_ret <= 1) {
    ...
    IDD_size = IDD_storage_size(filename);
    if (IDD_size < OC_MAX_APP_DATA_SIZE) {
