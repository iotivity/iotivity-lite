...
cloud_context_t TestCloudStore::s_context;
...
TEST_F(TestCloudStore, dump_async)
{
    ...
    EXPECT_EQ(store.expires_in, store1.expires_in);
    ...
    EXPECT_STREQ("coap+tcp://devices.ocfcloud.com:5684", oc_string(store1.ci_server));
#endif
}
