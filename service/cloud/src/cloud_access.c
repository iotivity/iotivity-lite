...
static bool _oc_sign_up(oc_endpoint_t *endpoint, const char *auth_provider,
...
static bool oc_sign_inout(oc_endpoint_t *endpoint, const char *uid,
                          const char *access_token, size_t device_index,
                          bool is_sign_in, oc_response_handler_t handler,
                          void *user_data) {
