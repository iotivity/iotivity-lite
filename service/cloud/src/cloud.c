...
void
cloud_manager_cb(cloud_context_t *ctx)
{
...
static void
cloud_manager_restart(cloud_context_t *ctx)
{
...
void
cloud_update_by_resource(cloud_context_t *ctx, const cloud_conf_update_t *data)
{
  cloud_manager_stop(ctx);
...
int
cloud_init(size_t device_index, cloud_cb_t callback, void *user_data)
{
...
cloud_context_t *
cloud_find_context(size_t device_index)
{
...
void
cloud_shutdown(size_t device_index)
{
...
void
cloud_set_last_error(cloud_context_t *ctx, cloud_error_t error)
{
...
void
cloud_reconnect(cloud_context_t *ctx)
{
