...
#define CLOUD_DEFAULT_CI_SERVER "coap+tcp://devices.ocfcloud.com:5684"
#define CLOUD_DEFAULT_AUTH_PROVIDER "ocfcloud.com"
...
void cloud_store_initialize(cloud_store_t *store) {
  cloud_set_string(&store->ci_server, CLOUD_DEFAULT_CI_SERVER,
                   strlen(CLOUD_DEFAULT_CI_SERVER));
  cloud_set_string(&store->auth_provider, CLOUD_DEFAULT_AUTH_PROVIDER,
                   strlen(CLOUD_DEFAULT_AUTH_PROVIDER));
