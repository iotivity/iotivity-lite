...
/**
  ...
  @param resource This is the resource which we need to register to RD.
   If null, oic/d and oic/p resources will be published.
...
*/
bool rd_publish(oc_endpoint_t *endpoint, oc_resource_t *resource, int device,
...
/**
  ...
  @return Returns true if success.
*/
bool rd_delete(oc_endpoint_t *endpoint, int device,
               oc_response_handler_t handler, void *user_data);
