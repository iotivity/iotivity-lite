 ...
 */
bool oc_sign_in(const char *host, const char *uid, const char *token,
                oc_response_handler_t handler, void *user_data);

/**
 * Function for sign-out to account server.
 */
bool oc_sign_out(const char *host, const char *token,
                 oc_response_handler_t handler, void *user_data);
...
bool oc_refresh_access_token(const char *host, const char *uid,
                             const char *token, oc_response_handler_t handler,
                             void *user_data);
