...
es_result_e construct_response_of_wificonf(void)
{
    ...
    oc_rep_set_int(root, OC_RSRVD_ES_SUPPORTEDWIFIFREQ, (int)g_ESWiFiConfResource.supported_freq);
...
es_result_e init_wifi_conf_resource(bool is_secured)
{
    ...
    if (NULL != wifi) {
        ...
        OC_ERR("Created WiFiConf resource with result: failure");
        return ES_ERROR;
    }
}
...
es_result_e init_coap_cloudconf_resource(bool is_secured)
{
    ...
    if ( NULL != cloud ) {
        ...
        OC_ERR("Created Cloud Conf resource with result: failure");
        return ES_ERROR;
    }
}
...
es_result_e init_devconf_resource(bool is_secured)
{
    ...
    if ( NULL != devconf ) {
        ...
        OC_ERR("Created DefConf resource with result: failure");
        return ES_ERROR;
    }
}
