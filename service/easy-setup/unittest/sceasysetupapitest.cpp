...
static void scan_access_points(sec_accesspoint_list **ap_list)
{
    (void)ap_list;
}
...
TEST_F(TestSCEasySetupAPI, InitAccessPointListResource_P)
{
    ...
    es_result_e ret = init_accesspointlist_resource(app_cbs);
...
{
    sec_accesspoint_cb app_cbs = {NULL, free_ap_list};
...
TEST_F(TestSCEasySetupAPI, InitAccessPointListResourceFreeAPListCallbackNULL_F2)
{
    sec_accesspoint_cb app_cbs = {scan_access_points, NULL};
