...
st_error_t st_manager_initialize(void) { return handle_request(ST_EVT_INIT); }

st_error_t st_manager_start(void) { return handle_request(ST_EVT_START); }

st_error_t st_manager_stop(void) { return handle_request(ST_EVT_STOP); }

st_error_t st_manager_deinitialize(void) {
  return handle_request(ST_EVT_DEINIT);
}

st_error_t st_manager_reset(void) { return handle_request(ST_EVT_RESET); }
#endif /* STATE */