...
static void st_stop_handlder(void);

static void st_reset_handlder(void);
...
{
  if (g_main_status == ST_STATUS_IDLE || g_main_status == ST_STATUS_INIT ||
      g_main_status == ST_STATUS_STOP) {
