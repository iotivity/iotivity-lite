...
void register_cloud_resources(void)
{
    ...
    res = oc_new_resource(NULL, "/oic/account/session", 1, 0);
    oc_resource_bind_resource_interface(res, OC_IF_BASELINE);
    oc_resource_set_discoverable(res, true);
    oc_resource_set_observable(res, true);
    ...
    oc_resource_set_discoverable(res, true);
    oc_resource_set_observable(res, true);
    oc_resource_set_request_handler(res, OC_POST, device_profile_post_handler, NULL);
    oc_add_resource(res);

    res = oc_new_resource(NULL, "/oic/rd", 1, 0);
    oc_resource_bind_resource_interface(res, OC_IF_BASELINE);
    oc_resource_set_discoverable(res, true);
    oc_resource_set_observable(res, true);
    oc_resource_set_request_handler(res, OC_POST, rd_post_handler, NULL);
    oc_add_resource(res);

    res = oc_new_resource(NULL, "/oic/ping", 1, 0);
    oc_resource_bind_resource_interface(res, OC_IF_BASELINE);
    oc_resource_set_discoverable(res, true);
    oc_resource_set_observable(res, true);
    oc_resource_set_request_handler(res, OC_GET, ping_get_handler, NULL);
    oc_resource_set_request_handler(res, OC_POST, ping_post_handler, NULL);
    oc_add_resource(res);
}
