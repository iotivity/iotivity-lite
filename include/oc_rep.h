...
#define oc_rep_start_array(parent, key)		do {			\
  ...
  g_err |= cbor_encoder_create_array(&parent, &key ## _array, CborIndefiniteLength)
...
#define oc_rep_close_array(object, key)		\
  oc_rep_end_array(object ## _map, key)

#define oc_rep_start_object(parent, key)     do {			\
