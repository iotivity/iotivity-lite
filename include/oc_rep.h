...
bool oc_rep_get_byte_string(oc_rep_t *rep, const char *key, oc_string_t *value);
bool oc_rep_get_string(oc_rep_t *rep, const char *key, oc_string_t *value);
bool oc_rep_get_array(oc_rep_t *rep, const char *key, oc_array_t *value, int *length);
bool oc_rep_get_int_array(oc_rep_t *rep, const char *key, int *value, int *length);
bool oc_rep_get_bool_array(oc_rep_t *rep, const char *key, bool *value, int *length);
bool oc_rep_get_double_array(oc_rep_t *rep, const char *key, double *value, int *length);
bool oc_rep_get_byte_string_array(oc_rep_t *rep, const char *key, oc_string_array_t *value, int *length);
bool oc_rep_get_string_array(oc_rep_t *rep, const char *key, oc_string_array_t *value, int *length);
