...
#ifndef OC_CLOUD_ACCESS_H
#define OC_CLOUD_ACCESS_H
...
{
  const oc_endpoint_t *endpoint; ///< cloud endpoint
  size_t device;                 ///< index of the device
  int selected_identity_cred_id; ///< selected identity certificate id
 ...
 */
OC_API
bool oc_cloud_access_deregister(oc_cloud_access_conf_t conf, const char *uid,
 ...
 */
OC_API
bool oc_cloud_access_login(oc_cloud_access_conf_t conf, const char *uid,
                           const char *access_token);
/**
 ...
 */
OC_API
bool oc_cloud_access_logout(oc_cloud_access_conf_t conf, const char *uid,
                            const char *access_token);
/**
 ...
 */
OC_API
bool oc_cloud_access_refresh_access_token(oc_cloud_access_conf_t conf,
