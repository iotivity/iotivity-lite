 ...
 */
OC_API
void plgd_wot_resource_set_td_properties_num(CborEncoder* parent_map, const oc_request_t *request, const plgd_wot_property_t* properties, size_t properties_count);
 ...
 * @param parent_map parent cbor encoder 
 * @param request incoming request to the resource
 * @param properties array of properties, must be terminated with a property with name == NULL.
 */
OC_API
