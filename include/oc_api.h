...
typedef void(*oc_con_app_read_cb_t)(int device_index);
typedef void(*oc_con_app_write_cb_t)(int device_index, 
                                     oc_rep_t *properties);
void oc_set_con_app_cb(oc_con_app_read_cb_t read_callback,
