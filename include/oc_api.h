...
/**
  ...
  and releases all direct resources associated with this collection.

  @note The function does not delete the links in the collection.
   The caller needs to do this on her/his own.
