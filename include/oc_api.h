...
/**
  ...
  @param  endpoint   Specific endpoint to discover resources. Must not be NULL.
  @param  user_data  Callback parameter for user defined value.
  @return Returns true if successfully make and dispatch coap packet.
*/
bool oc_do_ip_discovery_with_endpoint(const char *rt,
