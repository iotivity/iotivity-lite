...
#define oc_alloc_string( ocstring, size)                                       \
  __oc_alloc_string( __func__ , ocstring, size)
#define oc_new_string(ocstring, str, str_len)                                  \
  __oc_new_string( __func__, ocstring, str, str_len )

#define oc_free_string(ocstring) __oc_free_string( __func__ , ocstring)
#define oc_free_int_array(ocarray)                                             \
  (_oc_free_array(__func__ , ocarray, INT_POOL))
...
#define oc_free_string_array(ocstringarray)                                    \
  (__oc_free_string( __func__, ocstringarray))

#else

#define oc_alloc_string( ocstring, size) __oc_alloc_string( (ocstring), (size) )
#define oc_new_string(ocstring, str, str_len)                                  \
  __oc_new_string(ocstring, str, str_len)
