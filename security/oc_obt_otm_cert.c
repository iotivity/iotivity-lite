...
obt_cert_14(oc_client_response_t *data)
{
  ...
  const oc_device_t *device = o->device;
  const oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post(OCF_SEC_ACL_URI, ep, NULL, &obt_cert_15, HIGH_QOS, o)) {
...
obt_cert_13(oc_client_response_t *data)
{
  ...
  const oc_device_t *device = o->device;
  const oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_do_delete(OCF_SEC_ACL_URI, ep, NULL, &obt_cert_14, HIGH_QOS, o)) {
    return;
  }
...
obt_cert_11(oc_client_response_t *data)
{
  ...
  const oc_device_t *device = o->device;
  const oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post(OCF_SEC_DOXM_URI, ep, NULL, &obt_cert_12, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_cert_10(oc_client_response_t *data)
{
  ...
  const oc_device_t *device = o->device;
  const oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post(OCF_SEC_SDI_URI, ep, NULL, &obt_cert_11, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_cert_9(oc_client_response_t *data)
{
  ...
  bool derived = oc_sec_derive_owner_psk(
    ep, (const uint8_t *)OC_OXMTYPE_MFG_CERT_STR,
    OC_CHAR_ARRAY_LEN(OC_OXMTYPE_MFG_CERT_STR), device->uuid.id,
   ...
   */
  if (oc_init_post(OCF_SEC_CRED_URI, ep, NULL, &obt_cert_10, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_cert_7(oc_client_response_t *data)
{
  ...
  if (oc_init_post(OCF_SEC_ACL_URI, ep, NULL, &obt_cert_8, HIGH_QOS, o)) {
    const oc_uuid_t *my_uuid = oc_core_get_device_id(0);
    char uuid[OC_UUID_LEN];
    oc_uuid_to_str(my_uuid, uuid, OC_UUID_LEN);
...
obt_cert_6(oc_client_response_t *data)
{
  ...
  if (oc_init_post(OCF_SEC_DOXM_URI, ep, NULL, &obt_cert_7, HIGH_QOS, o)) {
    const oc_uuid_t *my_uuid = oc_core_get_device_id(0);
    char uuid[OC_UUID_LEN];
    oc_uuid_to_str(my_uuid, uuid, OC_UUID_LEN);
...
obt_cert_5(oc_client_response_t *data)
{
  ...
  if (oc_init_post(OCF_SEC_DOXM_URI, cep, NULL, &obt_cert_6, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_cert_4(oc_client_response_t *data)
{
  ...
  const oc_device_t *device = o->device;
  const oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post(OCF_SEC_DOXM_URI, ep, NULL, &obt_cert_5, HIGH_QOS, o)) {
    const oc_uuid_t *my_uuid = oc_core_get_device_id(0);
    char uuid[OC_UUID_LEN];
    oc_uuid_to_str(my_uuid, uuid, OC_UUID_LEN);
...
obt_cert_2(oc_client_response_t *data)
{
  ...
  if (oc_rep_get_int_array(data->payload, "oxms", &oxms, &oxms_len)) {
    ...
    if (oc_init_post(OCF_SEC_DOXM_URI, ep, NULL, &obt_cert_3, HIGH_QOS, o)) {
      oc_rep_start_root_object();
...
*/
int
oc_obt_perform_cert_otm(const oc_uuid_t *uuid, oc_obt_device_status_cb_t cb,
                        void *data)
{
   ...
   */
  const oc_endpoint_t *ep = oc_obt_get_unsecure_endpoint(device->endpoint);
  if (oc_do_get(OCF_SEC_DOXM_URI, ep, NULL, &obt_cert_2, HIGH_QOS, o)) {
    return 0;
  }
