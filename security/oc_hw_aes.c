...
{
    dna_aes_encrypt(input, 16, NULL, ctx->rk, DNA_AES_KEY_128BIT, DNA_NO_PADDING, output);
    return 0;
}
...
int mbedtls_internal_aes_decrypt( mbedtls_aes_context *ctx,
                                  ...
                                  unsigned char output[16] )
{
    dna_aes_decrypt(input, 16, NULL, ctx->rk, DNA_AES_KEY_128BIT, DNA_NO_PADDING, output);
    return 0;
}
