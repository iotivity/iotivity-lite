 ...
 */
void oc_certs_set_signature_md_algorithm(mbedtls_md_type_t md);
 ...
 */
mbedtls_md_type_t oc_certs_signature_md_algorithm(void);

/**
 * @brief Globally allow a single given message digest to be used in signatures.
 *
 * @param md message digest to allow
 */
void oc_certs_md_algorithm_allow(mbedtls_md_type_t md);

/**
 * @brief Globally allow a single given message digest to be used in signatures.
 *
 * @param md message digest to disallow
 */
void oc_certs_md_algorithm_disallow(mbedtls_md_type_t md);
 ...
 *
 * @see oc_certs_set_md_algorithm_allowed
 * @see oc_certs_md_algorithm_allow
 * @see oc_certs_md_algorithm_disallow
 */
int oc_certs_md_algorithm_allowed(void);
 ...
 *
 * @see oc_certs_md_algorithm_allowed
 * @see oc_certs_md_algorithm_allow
 * @see oc_certs_md_algorithm_disallow
 */
void oc_certs_set_md_algorithm_allowed(int md_mask);
 ...
 * @see oc_certs_md_algorithm_disallow
 */
bool oc_certs_md_algorithm_is_allowed(mbedtls_md_type_t md);
